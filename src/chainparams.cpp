...
const std::pair<const char*, CAmount> genesisOutputs[] = {       
    ...
    std::make_pair("036164a58c79d25fa35381648e42cb90e298ced7",250     * COIN),
    std::make_pair("4aba7cf3146da95e39743f5c59e0ee41c6082b3c",250     * COIN),
};
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlockMainNet(1557730800, 17314,  0x1f00ffff); // 2019-05-1 11:00:00
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000c12217a8006e19c667d9aa8c1ba1aff6d9664df2a17ac2a7165ce0330cae"));
        assert(genesis.hashMerkleRoot == uint256S("0x8b08014ca6e9c198aac58c4d24ba5ebce858f7bafa5e38d5dae066fef9340ed7"));
        assert(genesis.hashWitnessMerkleRoot == uint256S("0xaf3f183d279621c97bb51b8c3d2cf8cff56711b3fe78b7e68ddc99b67f0e2255"));
	...
	//assert(consensus.hashGenesisBlock == uint256S("0x0000ee0784c195317ac95623e22fddb8c7b8825dc3998e0bb924d66866eccf4c"));
        ...
        checkpointData = {
            {
                { 0,        uint256S("0x0000c12217a8006e19c667d9aa8c1ba1aff6d9664df2a17ac2a7165ce0330cae")},
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlockTestNet(1557813600, 10657, 0x1f00ffff); //2019-05-14
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000050cb58a922e51945ae6eb3dea3752c765fa8c648deca41ddf0710b9be39e"));
        assert(genesis.hashMerkleRoot == uint256S("0xa494cfe1c0e00930997f3adbd1dd88f672d6468b967786fc4504d6c0b6721c5b"));
        assert(genesis.hashWitnessMerkleRoot == uint256S("0x02c1faf150b3258183109cfc8dd9e06a13b615d66722c1fd570d25aff39d8a73"));
        ...
        checkpointData = {
            {
		{0, uint256S("0x000050cb58a922e51945ae6eb3dea3752c765fa8c648deca41ddf0710b9be39e")},
