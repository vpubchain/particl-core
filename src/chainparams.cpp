...
const std::pair<const char*, CAmount> genesisOutputs[] = {       
    //wallet-1
    std::make_pair("65c4a17e0bf327e48ecbf27c71364469c771288d",1250    * COIN),
    std::make_pair("45037fa2cd48bbcb2bf3f7162e0b98a414e3a07c",1250    * COIN),
    std::make_pair("ac9dd4989639205b58877abccb72b2444dda0ce2",1250    * COIN),
    std::make_pair("91935e6a721cd13f70421561ed72c7799da815e8",1250    * COIN),
    std::make_pair("f996659f7b18f28096b2a9131883151dce3efe47",1250    * COIN),
    
    std::make_pair("626d64ed4a15bc707c8be1ec594ec4e40090f8d3",1250    * COIN),
    std::make_pair("2c995fdfa9acb9f041853283a87c3b060b6695d1",1250    * COIN),
    std::make_pair("4c5d2193c3542234c03668a4683ac8227a753795",1250    * COIN),
    std::make_pair("3d54258eccfdf4d307d502ba47049ab7ce3e19f9",1250    * COIN),
    std::make_pair("b34a9152197e6728511e3ddf33ffb63232a19ace",1250    * COIN),
    
    std::make_pair("99146c9fc55564fc79363c8f88cc61a4a8e6581e",1250    * COIN),
    std::make_pair("a9d280cce4152fd8e0592cfd9980e8b97415edef",1250    * COIN),
    std::make_pair("473eb08b8565b8d708c892b11c0cca977db13512",1250    * COIN),
    std::make_pair("6d2bc306ee90aec445936ede34eea2269b4c767a",1250    * COIN),
    std::make_pair("81898fec6c1c2ecc4d2a6335c2b9a87243ad5ef7",1250    * COIN),  
    
    std::make_pair("57e6997b823048fac905f4d84b93033a946f94f0",1250    * COIN),
    std::make_pair("1cd9d068948153835cf0c1197bc207ce76de16be",1250    * COIN),
    std::make_pair("0903dec6dbdea193de8ada829edc7cf9f912b107",1250    * COIN),
    std::make_pair("5f59e4496cc9b93e0d4839cf635850909d662564",1250    * COIN),
    std::make_pair("485f78be76febe5814b28744ca6d6e141f91d167",1250    * COIN),
    ...
    std::make_pair("485f78be76febe5814b28744ca6d6e141f91d167",1250    * COIN),
    //wallet-2
    std::make_pair("91dc3d7313bd110c962746cf9374f42f4c593cd9",1250    * COIN),
    std::make_pair("e89bba31c6f03a14dedd22d93647b828ad37a790",1250    * COIN),
    std::make_pair("2f08154b5d9c3f814178f9a958c9d730d4d6a390",1250    * COIN),
    std::make_pair("290aa9f29385849a44b5276d2af7572dfc4dd788",1250    * COIN),
    std::make_pair("1ddad8b38f6314b0e191a698f32e439211430b66",1250    * COIN),
    
    std::make_pair("ba77337dceb08ace1f1bc2452f5df7690204c3d8",1250    * COIN),
    std::make_pair("e1bad841bf14bf2d5b6561511986c10b0c38a3c6",1250    * COIN),
    std::make_pair("3dc8ec6b6f270276b9566c47577c989951d97322",1250    * COIN),
    std::make_pair("26a963b19784482f45b6795701a77ac7493e6bfc",1250    * COIN),
    std::make_pair("f5adeb2820318d223955d50d692894762a0459e5",1250    * COIN),
    
    std::make_pair("8fb75a7a5df366aeb9501fd0300fd9e0ae5a242e",1250    * COIN),
    std::make_pair("ad352c2c804f6f9970e5e64e77ff3ad9b5fb68a7",1250    * COIN),
    std::make_pair("61c8002d4e22bcc7230fa9540d7b6567d0a99dbb",1250    * COIN),
    std::make_pair("f790c33189306efc43864931004912f204d4f49f",1250    * COIN),
    std::make_pair("7f03c5b051caf5cd5e880ae3eede5bf237742125",1250    * COIN),
    
    std::make_pair("072a6f113f219ce075129a8de051b4e30e8637b1",1250    * COIN),
    std::make_pair("0e3cc5c13ded120fa723c5a0d34990e3e214856f",1250    * COIN),
    std::make_pair("fe3e724d5621d89210427b07623723e4e54cc565",1250    * COIN),
    std::make_pair("b0870bbf28451b1e9d3e3be02e1e0f07a798848d",1250    * COIN),
    std::make_pair("6078d5a9f79f21bf5048c7fdc198544764f16475",1250    * COIN),
