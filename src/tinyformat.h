...
// must be included in all copies of the Software, in whole or in vp, and
...
// Print literal vp of format string and return next format spec
// position.
//
                       ...
                       int numFormatters)
{
    ...
    // Print remaining vp of format string.
    fmt = printFormatStringLiteral(out, fmt);
    if(*fmt != '\0')
